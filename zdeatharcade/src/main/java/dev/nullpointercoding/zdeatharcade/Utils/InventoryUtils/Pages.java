...
//open page 0 for the specified player
   ...
   //This creates a blank page with the next and prev buttons
    ...
    private ItemStack nextPage(){
        ...
        meta.lore(lore);
        PlayerProfile profile = CustomInvFunctions.getProfile("https://textures.minecraft.net/texture/18660691d1ca029f120a3ff0eabab93a2306b37a7d61119fcd141ff2f6fcd798");
    ...
    private ItemStack prevPage(){
        ...
        meta.lore(lore);
        PlayerProfile profile = CustomInvFunctions.getProfile("https://textures.minecraft.net/texture/52ba81b47d5ee06b484ea9bdf22934e6abca5e4ced7be3905d6ae6ecd6fcea2a");
        meta.setPlayerProfile(profile);
        head.setItemMeta(meta);
        return head;
